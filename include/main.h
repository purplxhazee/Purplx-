...
extern M5GFX&         g_lcd_primary;     // ST7789 240x135 (internal)
...
enum class AppState : uint8_t {
    ...
    TOOL_NOTES    = 62,   // SD notes / journal
    TOOL_FILES    = 63,   // SD file browser + hex viewer
    TOOL_QR       = 64,   // QR code generator
    TOOL_I2C      = 65,   // I2C bus scanner
    TOOL_HASH     = 66,   // MD5/SHA-256 file hasher
    TOOL_ALMANAC  = 67,   // Sun/moon almanac
    TOOL_VAULT    = 68,   // AES-256 password vault
    TOOL_TOTP     = 69,   // TOTP authenticator

    // System
    SYS_SETTINGS  = 90,
    SYS_INFO      = 91,
    SYS_CHARGING  = 92,
    SYS_FIRMWARES = 93,   // SD firmware launcher
    SYS_HELP      = 94,
    SYS_WIFI_OTA  = 95,   // WiFi firmware downloader
